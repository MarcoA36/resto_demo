...
export default function HeroSection() {
  const images = [
    "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1600&q=80&auto=format",
    "https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=1600&q=80&auto=format",
