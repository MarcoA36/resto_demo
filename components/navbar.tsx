      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/menu"
              className="bg-primary text-white px-6 py-2 rounded-lg font-semibold hover:bg-accent transition-colors"
            >
              Menú Digital
            </Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-2">
            ...
            <Link
              href="/menu"
              onClick={() => setIsOpen(false)}
              className="block w-full bg-primary text-white px-4 py-2 rounded-lg text-center"
            >
              Menú Digital
            </Link>
          </div>
